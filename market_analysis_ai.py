...
**重要：请使用纯文字格式输出，不要使用任何markdown语法、特殊符号、星号、井号、下划线等格式化字符。**
...
要求：
1. 使用纯文字，不使用任何markdown格式或特殊符号
2. 段落之间用空行分隔
3. 重点内容可以用"核心观点："、"风险提示："等文字标识
4. 避免使用星号、井号、下划线、粗体等格式化符号
5. 用专业、客观的语言，避免过于绝对的判断，注重数据支撑和逻辑推理

请确保输出的内容完全是纯文字格式，方便在PDF中进行排版。
"""
